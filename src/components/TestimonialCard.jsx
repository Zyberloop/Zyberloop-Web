...
export default function TestimonialCard({
    ...
    return (
        <div ref={cardRef} className='flex flex-col max-w-[350px] text-center py-10 bg-gradient-to-r from-card_color via-black to-card_color rounded-xl transition-transform duration-300'>
