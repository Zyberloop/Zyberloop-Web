...
const TechStack = () => {
    useEffect(() => {
        ...
        // Reduced Y-axis motion for skill icons
        gsap.to('.skill-icon-0', {
            ...
            motionPath: {
                path: [
                    { x: 0, y: -50 }, { x: 130, y: -25 }, { x: 150, y: 0 }, { x: 130, y: 25 },
                    { x: 0, y: 50 }, { x: -130, y: 25 }, { x: -150, y: 0 }, { x: -130, y: -25 },
                    { x: 0, y: -50 }
                ],
                alignOrigin: [0.5, 0.5]
        ...
        gsap.to('.skill-icon-2', {
            ...
            motionPath: {
                path: [
                    { x: 150, y: 0 }, { x: 130, y: 25 }, { x: 0, y: 50 }, { x: -130, y: 25 },
                    { x: -150, y: 0 }, { x: -130, y: -25 }, { x: 0, y: -50 }, { x: 130, y: -25 },
                    { x: 150, y: 0 }
                ],
                alignOrigin: [0.5, 0.5]
        ...
        gsap.to('.skill-icon-4', {
            ...
            motionPath: {
                path: [
                    { x: 0, y: -65 }, { x: 110, y: -32 }, { x: 130, y: 0 }, { x: 110, y: 32 },
                    { x: 0, y: 65 }, { x: -110, y: 32 }, { x: -130, y: 0 }, { x: -110, y: -32 },
                    { x: 0, y: -65 }
                ],
                alignOrigin: [0.5, 0.5]
        ...
        gsap.to('.skill-icon-5', {
            ...
            motionPath: {
                path: [
                    { x: 150, y: -25 }, { x: 130, y: 12 }, { x: 150, y: 25 }, { x: 130, y: -12 },
                    { x: -150, y: 25 }, { x: -130, y: -12 }, { x: -150, y: -25 }, { x: -130, y: 12 },
                    { x: 150, y: -25 }
                ],
                alignOrigin: [0.5, 0.5]
        ...
        gsap.to('.skill-icon-6', {
            ...
            motionPath: {
                path: [
                    { x: -100, y: -50 }, { x: 50, y: -25 }, { x: 100, y: 50 }, { x: -50, y: 25 },
                    { x: -100, y: -50 }
                ],
                alignOrigin: [0.5, 0.5]
            }
        ...
        gsap.to('.skill-icon-8', {
            ...
            motionPath: {
                path: [
                    { x: 100, y: 0 }, { x: 0, y: 50 }, { x: -100, y: 0 }, { x: 0, y: -50 },
                    { x: 100, y: 0 }
                ],
                alignOrigin: [0.5, 0.5]
            }
        ...
        gsap.to('.skill-icon-9', {
            ...
            motionPath: {
                path: [
                    { x: 0, y: 50 }, { x: 100, y: 0 }, { x: 0, y: -50 }, { x: -100, y: 0 },
                    { x: 0, y: 50 }
                ],
                alignOrigin: [0.5, 0.5]
            }
